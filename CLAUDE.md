...
**Updated:** 2026-04-15
**Branch:** feat/cave-agent-runtime
...
- Python runtime (`PythonRuntimeManager`) is shared across 3 tools: `python`, `python_reset`, `python_describe`

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **nanobot** (6051 symbols, 20614 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/nanobot/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/nanobot/context` | Codebase overview, check index freshness |
| `gitnexus://repo/nanobot/clusters` | All functional areas |
| `gitnexus://repo/nanobot/processes` | All execution flows |
| `gitnexus://repo/nanobot/process/{name}` | Step-by-step execution trace |
