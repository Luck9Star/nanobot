...
class ContextBuilder:
    ...
    def build_system_prompt(
        ...
        python_namespace_description: str | None = None,
    ) -> str:
        ...
        if python_namespace_description:
            parts.append(f"# Python Runtime (Stateful)\n\n{python_namespace_description}")
        ...
        messages = [
            {
                ...
                "content": self.build_system_prompt(
                    skill_names,
                    channel=channel,
                    python_namespace_description=python_namespace_description,
                ),
            },
            *history,
        ]
