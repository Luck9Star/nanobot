...
def _make_provider(config: Config):
    """Create the appropriate LLM provider from config (startup-time)."""
    ...
    return make_provider_for_model(config, model)
...
def serve(
    ...
    agent_loop = AgentLoop(
        ...
        python_runtime_config=runtime_config.tools.python_runtime,
...
def gateway(
    ...
    agent = AgentLoop(
        ...
        python_runtime_config=config.tools.python_runtime,
        cron_service=cron,
